...
Hello, It is a simple university project of database course. I have made a simple UI and basic SQL commands to make this project.
...
* Admin can add new employees, Assign individual Porjects, Check Salary, Check Status of projects, Mark the projects.
...
3. Goto phpmyadmin and create a database named **hems** and then import the file named **hems.sql**
